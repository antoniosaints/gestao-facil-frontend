<template>
    <div class="bg-body text-text dark:text-text-dark min-h-screen overflow-hidden flex flex-col">
        ...
        <aside id="sidebar-content-sistema"
            class="fixed shadow-md overflow-auto top-0 left-0 h-full w-full md:w-64 border border-border bg-white dark:bg-gray-900 p-4 space-y-4 transform transition-transform duration-300 ease-in-out z-40"
        ...
        <main id="container-main-app-sistema"
            class="overflow-y-auto h-[calc(100vh-5rem)] md:h-[calc(100vh-4.3rem)] p-6 mt-0 transition-all duration-300 ease-in-out"
