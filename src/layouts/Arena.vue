<template>
    <div class="bg-body min-h-screen overflow-hidden flex flex-col">
        ...
        <aside id="sidebar-content-sistema"
            class="fixed overflow-auto top-0 hidden_scrollbar left-0 h-full w-full border-r md:w-64 bg-yellow-800 dark:bg-yellow-950 p-4 space-y-4 transform transition-transform duration-300 ease-in-out z-40"
