  ...
  return [
      ...
      children: [
        {
          ...
          nome: 'Painel',
          link: '/ourive',
          show: ouriveAccess.has('VISUALIZAR'),
          icone: ChartPie,
          color: 'yellow',
        },
        {
        ...
        },
        {
          key: 'ourive:producao',
          nome: 'Produção',
          link: '/ourive/producao',
          show: ouriveAccess.has('PRODUCAO'),
          icone: Wrench,
          color: 'yellow',
        },
        {
          key: 'ourive:pedidos-compra',
        ...
        {
          key: 'ourive:financeiro',
          nome: 'Financeiro',
          link: '/ourive/financeiro',
          show: ouriveAccess.has('PAGAMENTOS'),
          icone: WalletCards,
          color: 'yellow',
        },
        {
          ...
          nome: 'Relatórios',
          link: '/ourive/relatorios',
          show: ouriveAccess.has('RELATORIOS'),
          icone: ChartPie,
          color: 'yellow',
        },
        {
          key: 'ourive:configuracoes',
          nome: 'Configurações',
          link: '/ourive/configuracoes',
          show: ouriveAccess.has('CONFIGURAR'),
          icone: Cog,
          color: 'yellow',
        },
      ],
    ...
    },
    {
      ...
      children: [
        ...
        {
          key: 'financeiro:plano-de-contas',
    ...
    },
    {
      ...
      children: [
        ...
        {
          key: 'notas-fiscais:nfe',
          nome: 'NF-e',
          link: '/notas-fiscais/nf-e',
          icone: FileText,
          color: 'cyan',
        },
        {
          key: 'notas-fiscais:nfce',
          nome: 'NFC-e',
