...
const routes: RouteInterface[] = [
  ...
  },
  {
    path: '/metas',
    name: 'metas',
    component: () => import('@/pages/metas/Home.vue'),
    meta: {
      layout: 'main',
      permissao: 1,
    },
    ...
    children: [
      {
        ...
        component: () => import('@/pages/notas-fiscais/Nfse.vue'),
        meta: { layout: 'main', permissao: 3 },
      },
      {
        path: 'configuracoes',
        name: 'notas-fiscais-configuracoes',
        component: () => import('@/pages/notas-fiscais/Configuracoes.vue'),
      ...
      },
      {
        ...
        props: {
          tipo: 'NFE',
          title: 'NF-e',
          description: 'Notas de produtos vinculadas às vendas e processadas pelo emissor fiscal.',
        },
        meta: { layout: 'main', permissao: 3 },
      },
      {
        path: 'nfc-e',
        name: 'notas-fiscais-nfce',
        component: () => import('@/pages/notas-fiscais/Documentos.vue'),
        props: {
          tipo: 'NFCE',
          title: 'NFC-e',
          description: 'Emissões ao consumidor iniciadas diretamente no PDV.',
        },
        meta: { layout: 'main', permissao: 3 },
      },
    ],
    ...
    children: [
      {
        path: '',
        name: 'ourive-painel',
        component: () => import('@/pages/ourive/Dashboard.vue'),
        meta: { layout: 'main', modulo: 'ourives', ouriveCapability: 'VISUALIZAR' },
      },
      {
        path: 'ordens',
        name: 'ourive-ordens',
        component: () => import('@/pages/ourive/Ordens.vue'),
        meta: { layout: 'main', modulo: 'ourives', ouriveCapability: 'VISUALIZAR' },
      },
      {
        path: 'ordens/:id',
        name: 'ourive-ordem',
        component: () => import('@/pages/ourive/OrdemDetalhe.vue'),
        meta: { layout: 'main', modulo: 'ourives', ouriveCapability: 'VISUALIZAR' },
      },
      {
        path: 'producao',
        name: 'ourive-producao',
        component: () => import('@/pages/ourive/Producao.vue'),
      ...
      },
      {
        ...
        meta: { layout: 'main', modulo: 'ourives', ouriveCapability: 'RECEBER' },
      },
      {
        path: 'equipe',
        name: 'ourive-equipe',
        component: () => import('@/pages/ourive/Equipe.vue'),
        meta: { layout: 'main', modulo: 'ourives', ouriveCapability: 'EQUIPE' },
      },
      {
        path: 'comissoes',
        name: 'ourive-comissoes',
        component: () => import('@/pages/ourive/Comissoes.vue'),
        meta: { layout: 'main', modulo: 'ourives', ouriveCapability: 'VISUALIZAR' },
      },
      {
        path: 'relatorios',
        name: 'ourive-relatorios',
        component: () => import('@/pages/ourive/Relatorios.vue'),
        meta: { layout: 'main', modulo: 'ourives', ouriveCapability: 'RELATORIOS' },
      },
      {
        path: 'configuracoes',
        name: 'ourive-configuracoes',
        component: () => import('@/pages/ourive/Configuracoes.vue'),
        meta: { layout: 'main', modulo: 'ourives', ouriveCapability: 'CONFIGURAR' },
      },
    ],
  },
  {
