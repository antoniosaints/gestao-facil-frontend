...
- `restaurante-repository.ts` concentra configuração, catálogo, zonas, checkout, acompanhamento, mesas/sessões/comandas, pontos de produção, tickets KDS e contratos de estações/regras/trabalhos de impressão do Restaurante.
