<template>
  <div
    v-if="isOpen"
    class="fixed inset-0 bg-black/50 flex items-center animate-in fade-in duration-300 justify-center z-50"
    @click="onNo"
  >
...
const { isOpen, title, message, cancelText, confirmText, onYes, onNo } = useConfirm()
</script>
