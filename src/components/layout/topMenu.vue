<template>
  ...
  >
    ...
    <button
      style="display: none"
      id="unsubscribeBtnHeader"
      class="px-3 py-0.5 rounded-md block md:hidden bg-blue-100 text-blue-600 hover:bg-blue-200 dark:bg-blue-800 dark:hover:bg-blue-700 dark:text-blue-200 transition-colors"
    >
      <i class="fa-solid fa-bell"></i>
    </button>
    <button
      style="display: none"
      id="subscribeBtnHeader"
      class="px-2 py-0.5 rounded-md block md:hidden bg-red-100 text-red-600 hover:bg-red-200 dark:bg-red-800 dark:hover:bg-red-700 dark:text-red-200 transition-colors"
    >
