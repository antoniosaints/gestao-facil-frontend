...
- A tela `configs/ConfiguracaoPage.vue` continua concentrando integrações operacionais da conta e volta a expor as credenciais próprias de AbacatePay do tenant, separadas das credenciais globais da plataforma.
