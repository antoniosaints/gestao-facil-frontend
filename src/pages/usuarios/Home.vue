        ...
        <div class="flex flex-col md:flex-row gap-2 justify-between mb-4">
            <div>
                <h2 class="flex items-center gap-2 text-2xl font-bold text-foreground">
                    <UserCog class="h-6 w-6 text-primary dark:text-white" :stroke-width="2.5" />
                    Usuários
                </h2>
            ...
            <div class="justify-between gap-2 items-center hidden md:flex">
                <button data-tour="novo-usuario" @click="store.openSave" class="bg-primary text-white px-2 py-1.5 text-sm rounded-md flex items-center gap-1">
