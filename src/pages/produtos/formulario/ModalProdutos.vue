...
<template>
    <div>
                ...
                <div class="bg-background dark:bg-background-dark rounded-md w-full h-full space-y-2">
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                        ...
                        <div class="md:col-span-4">
                            ...
                            <input v-model="store.form.preco" v-maska="moneyMaskOptions" type="text"
                                id="precoProdutoVenda" name="preco" required placeholder="Ex: 99,90"
                                class="w-full p-2 money_mask rounded-md border bg-card dark:bg-card-dark border-border dark:border-border-dark" />
                        </div>
        ...
        <Dialog v-if="isDesktop" v-model:open="store.openModal">
            <DialogContent class="sm:max-w-[425px] md:max-w-4xl grid-rows-[auto_minmax(0,1fr)_auto] p-0 max-h-[90dvh]">
                <DialogHeader class="p-6 pb-0">
                    <DialogTitle>Formulário de produtos</DialogTitle>
                    <DialogDescription>
        ...
        <Drawer v-else v-model:open="store.openModal">
            <DrawerContent>
                <DrawerHeader class="text-left">
                    <DrawerTitle>Formulário de produtos</DrawerTitle>
                    <DrawerDescription>
                        Faça o cadastro e alterações dos dados do produto
                    </DrawerDescription>
                </DrawerHeader>
