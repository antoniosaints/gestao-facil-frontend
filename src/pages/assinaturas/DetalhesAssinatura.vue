...
async function changeStatus() {
  try {
    ...
    console.error(error)
    toast.error('Erro ao atualizar o status da assinatura.')
  }
}
  ...
  <div class="space-y-4 pb-20 md:pb-0">
    <div class="flex flex-col gap-3 rounded-2xl border border-border/70 bg-card p-4 shadow-sm md:flex-row md:items-start md:justify-between">
      ...
      <div class="hidden flex-wrap items-center gap-2 md:flex">
        ...
        <Button class="gap-2" @click="generateCycle">
    ...
    <template v-else-if="detalhe">
      ...
      <div class="grid gap-4 xl:grid-cols-[1.2fr_0.8fr]">
        ...
        <Card class="shadow-sm">
          ...
          <CardContent class="space-y-3">
            ...
            <Button variant="outline" class="w-full" @click="changeStatus">Atualizar status</Button>
            <Button class="w-full gap-2" @click="generateCycle">
      ...
      <div class="grid gap-4 xl:grid-cols-[1.2fr_0.8fr]">
        ...
        <Card class="shadow-sm">
          ...
          <CardContent class="space-y-3">
            <div v-for="item in detalhe.itens.flatMap((entry) => entry.comodatos)" :key="item.id" class="rounded-2xl border border-border/60 bg-muted/10 p-4">
              <div class="flex flex-wrap items-center justify-between gap-2">
                <div>
            ...
            <div v-if="!detalhe.itens.flatMap((entry) => entry.comodatos).length" class="rounded-2xl border border-dashed p-4 text-center text-sm text-muted-foreground">
    ...
    <MobileBottomBar v-if="uiStore.isMobile">
      ...
      <button type="button" class="flex flex-col items-center text-gray-700 transition hover:text-primary dark:text-gray-300" @click="generateCycle">
