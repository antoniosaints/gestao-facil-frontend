...
- As listagens principais de contratos e planos em `assinaturas` agora seguem explicitamente o padrão `DataTable` + cards mobile paginados + modal de edição no mesmo contexto, em vez dos cards soltos como visão principal.
