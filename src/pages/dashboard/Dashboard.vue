  ...
  return [
    {
      ...
      detalhe: `${vendas?.totalFaturado || 0} venda(s) faturada(s) ou finalizada(s) no período`,
      icone: DollarSign,
    ...
    },
    {
      ...
      detalhe: 'Média das vendas faturadas ou finalizadas no período',
      icone: Receipt,
  ...
  return [
    {
      ...
      metrics: [
        ...
        { label: 'Concluídas', value: `${vendas?.totalFaturado || 0}` },
